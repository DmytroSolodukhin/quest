...
$catalogue = new MessageCatalogue('ru', array (
  ...
  array (
    ...
    'title_edit_profile_organizations' => 'Настройка организаций',
    'my_mail' => 'Мои сообщения',
    'my_quest' => 'Мои квесты',
    'my_time' => 'Заказы',
    'my_set_zakaz' => 'Бронь',
    'my_stat' => 'Статистика',
...
',
  ...
  array (
    ...
    'Crop & Use !' => 'Обрезать и использовать!',
    'Crop and Use' => 'Обрезать и использовать',
    'Drop your file here' => 'Перетащите ваши файлы сюда',
    'Edit' => 'Редактировать',
    'Failed to resize image' => 'Изменение размера не удалось',
    'Failed to write file to disk' => 'Запись файла на диск  не удалась',
    'File is too big' => 'Файл слишком большой',
    'File is too small' => 'Файл слишком маленький',
    'File upload aborted' => 'Загрузка файла отменена',
    'Filetype not allowed' => 'Тип файла не поддерживается',
    'Image exceeds maximum height' => 'Изображение превышает максимальную высоту',
    'Image exceeds maximum width' => 'Изображение превышает максимальную ширину',
    'Image requires a minimum height (%min%)' => 'Изображение требует минимальную высоту (%min%)',
    'Image requires a minimum width (%min%)' => 'Изображение требует минимальную ширину (%min%)',
    'Insert Image' => 'Вставить изображение',
    'Maximum number of files exceeded' => 'Превышено максимальное количество файлов',
    'Missing a temporary folder' => 'Временная папка отсутствует',
    'No file was uploaded' => 'Файл не загружен',
    'Please adjust selection to your image' => 'Пожалуйста, настройте выбранную область изображения',
    'Please select or upload an image' => 'Пожалуйта, выберите или загрузите изображение',
    'Select Existing' => 'Выбор из существующих',
    'Select a file...' => 'Выберите файл...',
    'The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form' => 'Загруженный файл превышает директиву MAX_FILE_SIZE, которая указана в HTML-форме',
...
',
  ...
  array (
    ...
    'Image requires a minimum height (%min%)' => 'Image requires a minimum height (%min%)',
    'Image requires a minimum width (%min%)' => 'Image requires a minimum width (%min%)',
    'Insert Image' => 'Insert Image',
    'Maximum number of files exceeded' => 'Maximum number of files exceeded',
    'Missing a temporary folder' => 'Missing a temporary folder',
    'No file was uploaded' => 'No file was uploaded',
    'Please adjust selection to your image' => 'Please adjust selection to your image',
    'Please select or upload an image' => 'Please select or upload an image',
