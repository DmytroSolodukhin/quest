...
class User extends \Application\Sonata\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addQuest($quest)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addQuest', [$quest]);

        return parent::addQuest($quest);
    }

    /**
     * {@inheritDoc}
     */
    public function removeQuest(\CoreBundle\Entity\Quest $quest)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeQuest', [$quest]);

        return parent::removeQuest($quest);
    }
