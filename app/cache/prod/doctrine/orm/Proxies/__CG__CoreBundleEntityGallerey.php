 ...
 */
class Gallerey extends \CoreBundle\Entity\Gallerey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'title', 'description', 'originalImage', 'image', 'gallery'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gallerey $proxy) {
