 ...
 */
class Time extends \CoreBundle\Entity\Time implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'open', 'quest', 'phone', 'visit', 'inprogress', 'price', 'count', 'id', 'title', 'description'];
        }
